...
help:
	...
	@echo 'bench               CPU-Benchmarks ausführen (nur Hinweis, kein Gate)'
...
lint:
	...
	$(PYTHON) scripts/rhythm_lint.py --text "Kurzer Test. Noch ein Satz." --scope user_text --mode sachlich --fail-on any > /dev/null
