...
Status: P0 source-of-truth matrix for v5.26.0.
...
| `german_pattern_lint.py` | 2, 8, 13, 16, 44, 54, 58, 64, 65; 72 advisory | Pattern 2 includes advertising-figure clusters with pattern-44 section evidence; pattern 44 remains partial; pattern 72 stays a context-dependent `info` candidate |
