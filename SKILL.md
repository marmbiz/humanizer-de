...
**Pass 5 – Selbst-Audit (immer).** Eigene Änderungen gegen Katalog, Zielprofil, Claim-Lock, Persona-Lock und Arbeitszweig prüfen: Hat eine Ersetzungsregel neue Monotonie erzeugt (gleiche Ersatzkonstruktion 3+ Mal → Strategie rotieren, vgl. Muster 16 vs. 51)? Positivkriterium: Rubrik-Check ([references/quality-rubric.md](references/quality-rubric.md)); benennen, welche Achse noch trägt. Danach Kurzaudit ausgeben. Fertig, wenn Restbefunde, verworfene Kandidaten und Ausgabeformat zum gewählten Zweig passen.
